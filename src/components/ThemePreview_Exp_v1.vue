...
<div class="text-center">
	<!-- <h1>ThemePreview_EXP (Experiment)</h1> -->
	<h1>ThemePreview (Experiment: v1)</h1>
	<div class="text-center">
		<v-card-text>
			<v-card  style="border:3px solid grey"
				...
				<v-chip v-for="colorArrayIndex in generateThemesWithAllColors()[themeIndex].colorArray.length"
						:color="generateThemesWithAllColors()[themeIndex].colorArray[colorArrayIndex - 1].code" label class="ma-1" :variant="chipVariant">
					<strong>{{ generateThemesWithAllColors()[themeIndex].colorArray[colorArrayIndex - 1].displayColor }}</strong>
					<v-avatar :style="{marginLeft:`1em`, background:generateThemesWithAllColors()[themeIndex].colorArray[colorArrayIndex - 1].code } " size="25"></v-avatar>
				</v-chip>

				<!-- <v-avatar 
					v-for="colorArrayIndex in generateThemesWithAllColors()[themeIndex].colorArray.length"
					:style="{ background: generateThemesWithAllColors()[themeIndex].colorArray[colorArrayIndex - 1].code }" size="30">
				</v-avatar> -->

				<!-- <span THEME_COLORS v-for="colorArrayIndex in generateThemesWithAllColors()[themeIndex].colorArray.length">
					<v-chip :style="{ background: generateThemesWithAllColors()[themeIndex].colorArray[colorArrayIndex - 1].code }" 
						...
						<strong :style="{ color: generateThemesWithAllColors()[themeIndex].colorArray[colorArrayIndex - 1].code }"> 
							{{ generateThemesWithAllColors()[themeIndex].colorArray[colorArrayIndex - 1].displayColor }}
						</strong>

					</v-chip>
				</span> -->
				<!-- <br /> -->
				<!-- <span THEME_NAMES v-for="colorArrayIndex in generateThemesWithAllColors()[themeIndex].colorArray.length">
